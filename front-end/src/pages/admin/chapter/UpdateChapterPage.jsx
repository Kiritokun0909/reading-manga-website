...
import { getChapterDetail, getDetailManga } from "../../../api/SiteService";
import { useRef } from "react";
import { deleteChapter, updateChapter } from "../../../api/AdminService";
...
export default function UpdateChapterPage() {
  ...
  useEffect(() => {
    const fetchManga = async () => {
      try {
        ...
        const mangaData = await getDetailManga(chapterData.mangaId);
        setManga(mangaData.mangaInfo);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setLoading(false);
      toast.success("Cập nhật chương thành công");
    } catch (error) {
      toast.error(error.message);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setLoading(false);
      toast.success("Xoá chương thành công");
  ...
  return (
    <div className="flex flex-col">
        ...
        {manga.isManga === 1 ? (
          <div className="flex justify-center mt-2 flex-col items-center">
            ...
            >
              ...
              <p>
                (Vui lòng tải lại toàn bộ ảnh của chương và format tên ảnh theo
                thứ tự trang trước khi tải lên)
              </p>
            </button>
            <div className="flex justify-center mt-2 flex-col items-center">
            ...
            {chapterFiles.map((image, index) => (
              ...
              >
                ...
                <img
                  src={previewImages[index].previewUrl || image.imageUrl}
      ...
      <div className="flex justify-center mt-4">
        ...
        <button
          className="p-2 py-1.5 px-3 m-1 text-center bg-red-700 border rounded-md text-white  hover:bg-red-500 hover:text-gray-100 dark:text-gray-200 dark:bg-violet-700"
